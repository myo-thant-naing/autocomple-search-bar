...
const navigatedAndSelectProduct = (key) =>{
    ...
    else if (key === "ArrowUp")
    {
     ...
     productitemContainerToSelect.classList.add("Selected");
       ...
       const selectedProductWithEnter = selectProduct(indexToSelect);
       console.log(selectedProductWithEnter);
       resultContainerTag.style.display = "none";
       if(resultContainerTag.innerHTML = ""){
...
const selectProduct = (index) =>{
    const productIdToSelect = filteredProducts[indexToSelect].id.toString();
        ...
        productitemContainerToSelect.style.backgroundColor = "lightgray";
